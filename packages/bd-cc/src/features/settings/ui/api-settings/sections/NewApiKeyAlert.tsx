...
export default function NewApiKeyAlert({ apiKey, copiedKey, onCopy, onDismiss }: NewApiKeyAlertProps) {
  ...
  return (
    <div className="rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4">
      ...
      <div className="flex items-center gap-2">
        <code className="flex-1 break-all rounded bg-background/50 px-3 py-2 font-mono text-sm">{apiKey.apiKey}</code>
        <Button size="sm" variant="outline" onClick={() => onCopy(apiKey.apiKey, 'new')}>

...
import type { McpServer, McpToolsResult, McpTestResult } from '@/components/settings/types/types';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {servers.length === 0 && <div className="py-8 text-center text-muted-foreground">{t('mcpServers.empty')}</div>}
      </div>
    </div>
  );
}

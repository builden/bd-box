...
export default function GitSettingsTab() {
  ...
  const { gitName, setGitName, gitEmail, setGitEmail, isLoading, isSaving, saveStatus, saveGitConfig } =
    useGitSettings();
        ...
        <SettingsCard className="p-4">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <Button onClick={saveGitConfig} disabled={isSaving || !gitName.trim() || !gitEmail.trim()}>

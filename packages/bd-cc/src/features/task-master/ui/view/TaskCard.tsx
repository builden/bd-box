    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <h3 className="line-clamp-2 text-sm font-medium leading-tight text-gray-900 dark:text-white">{task.title}</h3>
      ...
      {progress.total > 0 && (
        <div className="ml-3">
          <div className="mb-1 flex items-center gap-2">
            ...
            <div
              className="h-1.5 flex-1 rounded-full bg-gray-200 dark:bg-gray-700"

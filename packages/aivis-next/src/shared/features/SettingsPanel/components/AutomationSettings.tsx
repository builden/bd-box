    ...
    <>
      ...
      <div>
        <div className="flex items-center justify-between min-h-6">
          <span className="text-text-primary text-[13px] font-medium tracking-tight">MCP 连接</span>
          {endpoint && (
            <span
              className={clsx(
      ...
      <div className="flex flex-col flex-1">
        <div className="flex items-center justify-between min-h-6">
          <span className="text-text-primary text-[13px] font-medium tracking-tight">Webhooks</span>
          <CheckboxField
            label="自动发送"
        ...
        <p className="text-text-muted text-xs pt-1.5">Webhook URL 将接收实时标注变更和标注数据</p>
        <textarea
          ...
          className={clsx(
            ...
            'text-text-primary text-[12px] placeholder:text-text-muted',

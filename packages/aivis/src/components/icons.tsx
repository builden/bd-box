...
export const IconListSparkle = ({ size = 24, style = {} }: { size?: number; style?: React.CSSProperties }) => (
    ...
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <g className={`${s.iconStateFast} ${showError ? s.visibleScaled : s.hiddenScaled}`}>
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M12 8V12" stroke="var(--agentation-color-red)" strokeWidth="1.5" strokeLinecap="round" />
        <circle
          cx="12"
          cy="15"
          r="0.5"
...
export const IconChatEllipsis = ({ size = 16, style = {} }: { size?: number; style?: React.CSSProperties }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <path
